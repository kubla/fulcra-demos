...
- [scripts/](scripts/) contains local CLI helpers and shared location-visit logic.
...
[scripts/location_visits_logic.py](scripts/location_visits_logic.py) and is the
